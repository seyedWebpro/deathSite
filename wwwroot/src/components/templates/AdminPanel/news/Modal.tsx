    ...
    <Dialog>
      <DialogTrigger asChild>
        <Button variant={"default"}>
          {props.newNews ? "+ اخبار جدید " : props.newShow ? "مشاهده" : "ویرایش"}
        </Button>
      </DialogTrigger>
      <DialogContent className="w-full max-w-[425px] sm:max-w-full">
        <DialogHeader>
          <DialogTitle className="flex items-center justify-end gap-2 py-3">
            { props.newNews ? 'اخبار جدید': props.newShow
              ? "  مشاهده اخبار 1122811228"
              : "  ویرایش اخبار 1122811228"}
          </DialogTitle>
        </DialogHeader>
            ...
            <>
              ...
              <div>
                ...
                <div className="relative flex items-center justify-center gap-2 p-8 text-center">
                  ...
                  <p className="my-4">عکس خبر را انتخاب کنید</p>
                  <input
